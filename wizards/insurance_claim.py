    ...
    def insurance_claim_create(self):
        ...
        for rec in self.insurance_id:
            ...
            data = {
                ...
                'policy_holder_dob': nominee.nominee_dob,
                'policy_holder_age': nominee.nominee_age,
                'policy_holder_gender': nominee.insured_gender,

                'insured_id': rec.insured_id.id,
                'gender': nominee.insured_gender,
                'dob': nominee.nominee_dob,
                'age': nominee.nominee_age,
                'marital_status': nominee.insured_marital_status,
                'blood_group': nominee.insured_blood_group,
                'insured_height': nominee.insured_heights,
                'insured_weight': nominee.insured_weights,
                'insured_birthmark': nominee.insured_blood_group,
